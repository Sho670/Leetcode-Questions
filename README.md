...
This repository contains my personal solutions to LeetCode problems written in Python 3.8 and Java serving as a log of my practice with data structures and algorithm design. 
...
To test any solution locally, clone the repository using `git clone https://github.com/your-username/leetcode-python.git`, navigate to the project directory, and execute the desired file directly using `python 01_two_sum.py`. 
